...
function Modifierphoto() {
  ...
  // Charger les données du produit à partir de l'API avec l'ID
  useEffect(() => {
    async function fetchPhotoData() {
      try {
        ...
        // Mettre à jour le formulaire avec les données de la photo
    ...
    fetchPhotoData(); // Charger les données de la photo lors du montage du composant
  }, [id]);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (data.message !== `La photo ${data.data.name} a bien été modifié.`) {
